...
//Declare Version
var magicBootTabsVersion = "1.56";

// colorConsole Check
if (typeof colorConsole != 'undefined') {
	...
	if (typeof jQuery != 'undefined') {
		...
		if (typeof($.fn.tab) != 'undefined') {
			...
			console.log(Array(
				Array("MagicBootTabs", "#bada55"),
				Array("Plugin Requires Bootstrap 3 (JS - Tabs)!", "#F53C2B")
			));
		}
		...
		console.log(Array(
			Array("MagicBootTabs", "#bada55"),
			Array("Plugin Requires JQuery!", "#F53C2B")
		));
	}

} else {

	// Log colorConsole Error In Console
	console.log("MagicBootTabs Plugin Requires colorConsole!");
}